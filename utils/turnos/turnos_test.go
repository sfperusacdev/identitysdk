...
func (s TestSegment) NewSegment(codigo string, inicio, fin time.Time) turnos.Segmentable {
	return TestSegment{CodigoTurno: codigo, FechaInicio: inicio, FechaFin: fin}
}
